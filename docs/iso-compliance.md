...
**Release strategy**: Option β (ship 2026-05-01 with disclosure; close compliance gaps in subsequent releases).
...
**Target date**: P0 / P1 items carry a target version (e.g. a specific patch like `v1.0.X`, or a minor like `v1.1.0`) rather than a calendar date — calendar dates rot faster than version-pegged commitments under the project's irregular release cadence. Items still showing "TBD" carry no scheduled commitment until promoted to a version target.
